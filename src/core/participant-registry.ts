...
export class ParticipantRegistry {
  ...
  // Prepared statements
  private insertParticipant: any
  private updateParticipantStmt: any
  private selectParticipant: any
  private selectAllParticipants: any
  private deleteParticipant: any
  private updateLastSeenStmt: any
   ...
   */
  async registerParticipant(participant: Omit<Participant, 'last_seen' | 'status'>): Promise<Participant> {
  ...
  async updateParticipant(
    ...
    updates: Partial<Pick<Participant, 'capabilities' | 'status' | 'preferences' | 'default_priority'>>,
