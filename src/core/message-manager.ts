...
export class MessageManager {
  ...
  private insertMessage: any
  private updateMessage: any
  private selectMessages: any
  private selectMessageById: any
  private deleteMessage: any
  private selectMessageDependencies: any
  ...
  private async storeMessageContent(threadId: string, messageId: string, content: string): Promise<string> {
  ...
  private async rowToMessage(row: MessageRow, detailLevel: 'index' | 'summary' | 'full'): Promise<CoordinationMessage> {
    const message: CoordinationMessage = {
      id: row.id,
