...
export class SQLSanitizer {
    ...
    static MAX_QUERY_LENGTH = 10000;
    static MAX_IDENTIFIER_LENGTH = 64;
    /**
     ...
     */
    static createPlaceholder(paramName) {
     ...
     */
    static validateIdentifierInput(identifier) {
     ...
     */
    static validateQueryInput(query) {
     ...
     */
    static sanitizeStringLiteral(value) {
     ...
     */
    static sanitizeNumericLiteral(value) {
     ...
     */
    static validateQueryStructure(normalizedQuery) {
