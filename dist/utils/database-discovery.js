 ...
 */
export async function discoverDatabases(currentDir = process.cwd()) {
    const databases = [];
 ...
 */
export function suggestBestDatabase(databases) {
 ...
 */
export function generateFragmentationWarnings(databases, currentDir) {
    const warnings = [];
 ...
 */
export function shouldCentralizeCoordination(databases) {
...
async function getParticipantCount(configDir) {
    try {
...
async function getLastActivity(dbPath) {
    try {
